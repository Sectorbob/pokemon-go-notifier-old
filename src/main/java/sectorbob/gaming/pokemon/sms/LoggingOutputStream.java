...
public class LoggingOutputStream extends OutputStream {
     ...
     *
     * @param level
     *            set the logging level for the stream
     *
    ...
    final byte[] theBytes = new byte[count];
        ...
        switch(level) {
            case TRACE:
                log.trace(new String(theBytes)); break;
            case DEBUG:
                log.debug(new String(theBytes)); break;
            case INFO:
                log.info(new String(theBytes)); break;
            case WARN:
                log.warn(new String(theBytes)); break;
            case ERROR:
                log.error(new String(theBytes)); break;
            default:
